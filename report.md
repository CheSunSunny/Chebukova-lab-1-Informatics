...
Добавим в неё символ специальной переменной $*. При выполнении файла переменная будет содержать все аргументы, которые мы запишем в командной строке при запуске скрипта.
